...
export default function ProfileButton() {
  ...
  return (
    <div className='relative'>
      ...
      <div className={'absolute right-0 translate-y-3 translate-x-3 sm:translate-x-0 bg-py shadow-md rounded-2xl flex flex-col w-60 border transition-all origin-top-right z-40 ' + (open ? "scale-100" : "scale-0")}>
