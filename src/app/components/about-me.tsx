        ...
        <section id='aboutme' className="flex items-center justify-center" style={{
            ...
            <div className="bg-sy/5 backdrop-blur border border-sy/40 rounded-3xl shadow shadow-bd/5 stroke-effect flex flex-col sm:flex-row" style={{
                ...
                <div>
                    ...
                    <p className="text-sm p-6 pt-0 opacity-50">I am a full stack web developer. I have serious passion for UI effects, animations and creating intuitive, dynamic user experiences. Lets make something special.</p>
                </div>
            </div>
